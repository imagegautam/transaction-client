  ...
  return (
    <AuthComp loggedInUser={loggedInUser}>
      ...
      <Container className="main pt-2">
        ...
        <CustomModel title= "Add new transaction" show={showForm} setShowForm={setShowForm}>

        <NewTransForm getUserTransactions={getUserTransactions} setShowForm={setShowForm} />
